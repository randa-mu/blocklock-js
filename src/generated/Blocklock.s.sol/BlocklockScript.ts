...
export interface BlocklockScriptInterface extends Interface {
...
export interface BlocklockScript extends BaseContract {
  connect(runner?: ContractRunner | null): BlocklockScript;
  waitForDeployment(): Promise<this>;

  interface: BlocklockScriptInterface;
