...
export interface BlocklockUpgradeScriptInterface extends Interface {
...
export interface BlocklockUpgradeScript extends BaseContract {
  connect(runner?: ContractRunner | null): BlocklockUpgradeScript;
  waitForDeployment(): Promise<this>;

  interface: BlocklockUpgradeScriptInterface;
